...
pionRouge = Piece('b', 'p', 'pionRouge')
pionBleu = Piece('w', 'p', 'pionBleu')

roiRouge = Piece('b', 'k', 'roiRouge')
roiBleu = Piece('w', 'k', 'roiBleu')



starting_order = {(0, 0): pygame.image.load(pionRouge.image), (0, 1): pygame.image.load(pionRouge.image),
                  (0, 2): pygame.image.load(roiRouge.image),
                  (0, 3): pygame.image.load(pionRouge.image), (0, 4): pygame.image.load(pionRouge.image),
                  ...
                  (4, 0): pygame.image.load(pionRouge.image), (4, 1): pygame.image.load(pionRouge.image),
                  (4, 2): pygame.image.load(roiRouge.image),
                  (4, 3): pygame.image.load(pionRouge.image), (4, 4): pygame.image.load(pionRouge.image)}
